...
const Navbar = () => {
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-expand-sm navbar-expand-md  ${
      ...
      <div className="container-fluid">
        ...
        <div className="container-fluid d-flex flex-row" id="navbarNav">
          ...
          {scrolled && (
            <div className="d-flex flex-row align-items-center whatsapp-link">
              <a className="btn btn-success rounded-pill " href="#whatsapp">
                <svg
