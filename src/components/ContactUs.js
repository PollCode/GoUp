    ...
    <div className="contact-box row mt-5">
      <div className="col-lg-6 txtbox d-flex flex-column justify-content-center align-items-start">
        ...
        <p className="contactus-text">
          ...
          we'll work with you to create a personalized care plan that meets your
          child's unique needs. We look forward to hearing from you!
        </p>
      </div>
          ...
          <div className="col-12">
            <div className="input-group ">
              <input
                ...
                id="inputMessage"
                placeholder="Message"/>
              <button type="submit" class="btn btn-danger btn-mssg rounded-pill">
                <svg
                  width="26"
                  height="26"
                  viewBox="0 0 26 26"
