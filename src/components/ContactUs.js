    ...
    <>
      <div id="contact">
        <div className="contact-box row mt-5">
          <div className="col-lg-6 txtbox d-flex flex-column justify-content-center align-items-start">
            <p className="contactus-header">CONTACT US</p>
            <p className="txt-help">WELCOME</p>
            <p className="contactus-text">
              We're glad you're interested in learning more about how we can
              help care for your child. Please feel free to leave us a message
              on our contact form and tell us a little bit about your child and
              their needs. Our team is dedicated to providing the best possible
              care and we'll work with you to create a personalized care plan
              that meets your child's unique needs. We look forward to hearing
              from you!
            </p>
          </div>
